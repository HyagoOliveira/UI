...
public class UIPanel : CanvasDrawer
{
    ...
    [Required] public Text titleText;
    [Required] public Text messageText;
    [Required] public Button noButton;
    [Required] public Button yesButton;
    ...
    protected override void Reset()
    {
        ...
        titleText = transform.FindChildComponent<Text>("TitleText");
        messageText = transform.FindChildComponent<Text>("MessageText");
        noButton = transform.FindChildComponent<Button>("NoButton");
        yesButton = transform.FindChildComponent<Button>("YesButton");
    }
